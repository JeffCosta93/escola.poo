...
class App:
    def __init__(self):
        ...
        # Entry
        self.txt_matricula = Entry(self.janela, font="Tahoma 14", width=27,
                                   state=DISABLED)
        ...
        self.combo_curso = ttk.Combobox(self.janela, values=self.cursos,
        ...
        self.button_adicionar = Button(self.janela, text="Adicionar",
                                       font="Tahoma 12 bold", width=7, fg="blue",
        ...
        self.button_deletar = Button(self.janela, text="Deletar",
                                     font="Tahoma 12 bold", width=7, fg="blue",
